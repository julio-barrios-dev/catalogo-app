...
export default function CatalogoClient({ designs }: { designs: Design[] }) {
  ...
  return (
    <div className="min-h-dvh bg-white">
      ...
      <header className="py-7 px-6 text-center bg-white">
        <p className="text-[11px] font-bold text-amber-500 uppercase tracking-widest mb-2.5">
          Souvenir Exacto
        </p>
        <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight tracking-tight max-w-xl mx-auto">
          Elegí el diseño ideal para tu evento
        </h1>
        <p className="mt-3 text-gray-400 text-sm max-w-md mx-auto leading-relaxed">
          Todos los diseños son personalizables. Filtrá, buscá y seleccioná los que más te gusten.
        </p>

        {/* Custom design CTA — compact secondary link */}
